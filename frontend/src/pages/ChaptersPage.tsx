        ...
        <div className="grid gap-4">
          {chapters?.map((chapter) => (
            <button
              ...
              className="w-full p-5 rounded-2xl bg-white border-2 border-indigo-100 hover:border-indigo-400 text-left shadow-sm transition-colors"
            >
              <p className="text-xl font-semibold text-indigo-700">{chapter.title}</p>
            </button>
          ))}
        </div>
      ) : (
